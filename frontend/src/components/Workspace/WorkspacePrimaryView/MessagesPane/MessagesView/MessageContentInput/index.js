...
const MessageContentInput = ({ messageableId, messageableType, messageMembersArr, defaultVal, content, isCreate, message, setShowEditContent }) => {
    ...
    return (
        <div className="create-message-container">
            <div className="top-message-options"></div>
            ...
            <div className="bottom-message-options">
                ...
                <div className="bottom-right-options">
                    <div className="bottom-buttons-container">
                        ...
                        <span>
                            <button onClick={isCreate ? handleCreateMessage : handleUpdateMessage} className="create-message-send-button small-button" disabled={messageContent === "" || messageContent === defaultVal || messageMembersArr.length === 1 }>
